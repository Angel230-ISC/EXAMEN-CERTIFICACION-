...
const tiempoLimite = (user.duracionExamen || 120000);

// ⚙️ Si el examen llega justo al límite, se permite enviar
if (tiempoPasado - tiempoLimite > 2000) { // tolera 2 segundos de desfase
  ...
  //Aqui comienza la validacion de las respuestas
  let correctas = 0;
