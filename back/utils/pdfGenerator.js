...
exports.createCertificate = (nombre, calificacion) => {
  ...
  // Ajustamos las posiciones para que no tapen los nombres
  const yFirmas = doc.page.height - 160; // firmas más arriba
  const yTexto = doc.page.height - 95;   // texto más abajo
  ...
  doc
    ...
    .fontSize(14)
    .fillColor("#003366")
    .text("CodeVerse Academy", 80, yTexto, { align: "left" });
  ...
  // === 🔲 Marco decorativo (opcional, delgado) ===
  doc
    .lineWidth(2)
    .strokeColor("#003366")
